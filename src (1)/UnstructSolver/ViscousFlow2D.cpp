    ...
    : TopologyHolderStrategy(hder,4)
{
...
#endif // DEBUG
    TopologyHolderStrategy::set_fs_variable2(0.73, 2.79, 1.225, 101325, 6.5e6);
    //
    ...
    turbModelTimeStrategy = new LUSGSStrategy(d_hder,d_turbulentModel);
...
void ViscousFlow2D::initializeData()
{
    ...
    turbModelTimeStrategy->initialize();
}
